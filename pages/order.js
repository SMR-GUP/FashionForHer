  ...
  return (
    <div className="min-h-screen bg-indigo-500 text-white p-8">
      <div className="max-w-4xl mx-auto bg-white text-black rounded-lg shadow-lg p-6">
        ...
        <img src="/greentick.jpg" alt="Green Tick" className="mx-auto mb-1 w-38 h-32" />
    ...
    <table className="min-w-full bg-white">
      <tbody>
        <tr className="bg-blue-100">
          ...
          <td className="px-4 py-2">{details.firstName + " " + details.lastName}</td>
        </tr>
    ...
    <table className="min-w-full bg-white">
      <tbody>
        ...
        <tr className="bg-yellow-100">
          <td colSpan="3" className="text-lg px-4 py-2 font-semibold text-right">Amount Payable At Delivery:</td>
          <td className="text-lg px-4 py-2 font-semibold">₹{details.amount}</td>
        </tr>
        <tr className="bg-yellow-100">
          <td colSpan="3" className="text-lg px-4 py-2 font-semibold text-right">Expected Delivery Date:</td>
          <td className="text-lg px-4 py-2 font-semibold">{deliveryDate.toDateString()}</td>
        </tr>
      </tbody>
    </table>
  </div>
        ...
        <Link href="/" className=" text-blue-950 hover:underline">Back to Home</Link>
        <Link href="/profile " className='ml-3  text-blue-950 hover:underline'>View your orders</Link>
