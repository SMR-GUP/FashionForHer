...
import { BiEyeSlash } from 'react-icons/bi';
import { BiEye } from 'react-icons/bi';
...
const ForgotPassword = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-forgot">
      ...
      <img src="/password.png" alt="Description of image" className="w-1/2 h-auto rounded-lg" />
        ...
        {!showOtpForm && !showResetForm && (
          <form onSubmit={handleEmailSubmit}>
            ...
            <div className="w-full bg-gray-200 rounded mt-4">
              <div className="bg-blue-500 text-xs leading-none py-1 text-center text-white rounded" style={{ width: '50%' }}>
                Sending...
              </div>
            </div>
          )}
        ...
        {showOtpForm && (
          <form onSubmit={handleOtpSubmit}>
            <h2 className="text-2xl font-bold mb-6 text-center text-gray-700">Enter OTP</h2>
            <input
              type="text"
              value={otp}
