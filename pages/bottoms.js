  ...
  return (
    <div>
     <section className="text-gray-600 body-font">
        <div>
          <h1 className="text-black text-3xl flex items-center justify-center mb-5 mt-3">BottomWear</h1>
        </div>
        <div className="container px-5  mx-auto">
          ...
          {bottomwear.map((bottomwear) => (
              <div key={bottomwear._id} className="lg:w-1/5 md:w-1/2 p-3 w-full shadow-lg m-7">
                <Link href={`/bottomwear/${bottomwear._id}`} className="block relative h-48 rounded overflow-hidden">
                  <img
                    alt="ecommerce"
                ...
                <p class="text-gray-500 mt-1 font-serif">26 , 28 , 30 , 32 , 34</p>
              </div>
                </div>
              </div>
            ))}
