  ...
  return (
    <div>
      <section className="text-gray-600 body-font">
        <div>
          <h1 className="text-black text-3xl flex items-center justify-center mb-5 mt-3">Dresses</h1>
        </div>
        <div className="container px-5  mx-auto">
          ...
          {dresses.map((dress) => (
              <div key={dress._id} className="lg:w-1/5 md:w-1/2 p-3 w-full shadow-lg m-7">
                <Link href={`/dress/${dress._id}`} className="block relative h-48 rounded overflow-hidden">
                  <img
                    alt="ecommerce"
